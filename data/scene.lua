	...
	
	{
		...
		components = 
		{
			...
			CTransform = 
			{
				...
				orientation_y = 0,
				orientation_z = 0,
				pos_x = 10.196830749512,
				pos_y = 6.8048543930054,
				pos_z = 1.6766599416733,
				scale_x = 1,
				scale_y = 1,
				scale_z = 1,
			},
	...
	
	{
		...
		components = 
		{
			...
			CTransform = 
			{
				...
				orientation_y = 0,
				orientation_z = 0,
				pos_x = -4.0404949188232,
				pos_y = 0.48490619659424,
				pos_z = 10.615114212036,
				scale_x = 1,
				scale_y = 1,
				scale_z = 1,
			},
	...
	
	{
		...
		components = 
		{
			CPolyMesh = 
			{
				...
				texturePath = "data/textures/prototype/Dark/texture_01.png",
			},
			CRenderable = 
			{
				color_a = 1,
