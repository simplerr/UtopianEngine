actor_list = 
{
	...
	
	{
		...
		components = 
		{
			...
			CTransform = 
			{
				...
				orientation_z = 0,
				pos_x = -63.0700340271,
				pos_y = 1.6330459117889,
				pos_z = 11.500547409058,
				scale_x = 1,
				scale_y = 1,
				scale_z = 1,
			},
	...
	
	{
		...
		components = 
		{
			...
			CTransform = 
			{
				...
				orientation_y = 0,
				orientation_z = 0,
				pos_x = -13.937437057495,
				pos_y = 1.6335691213608,
				pos_z = 11.521283149719,
				scale_x = 1,
				scale_y = 1,
				scale_z = 1,
			},
	...
	
	{
		...
		components = 
		{
			...
			CTransform = 
			{
				...
				pos_x = -12.166912078857,
				pos_y = 3.4327096939087,
				pos_z = 11.309766769409,
	...
	
	{
		...
		components = 
		{
			CPolyMesh = 
			{
				modelPath = "data/models/polymesh/polymesh-195757556382754712.obj",
				texturePath = "data/textures/prototype/Orange/texture_01.ktx",
			},
			CRenderable = 
			{
			...
			CTransform = 
			{
				...
				orientation_y = 0,
				orientation_z = 0,
				pos_x = -15.28714466095,
				pos_y = 0.49915036559105,
				pos_z = 11.472507476807,
				scale_x = 1,
				scale_y = 1,
				scale_z = 1,
			},
