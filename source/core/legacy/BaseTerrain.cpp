...
namespace Utopian
{
	...
	void BaseTerrain::Update()
	{
		...
		int32_t blockViewDistance = gRenderer().GetRenderingSettings().blockViewDistance;
		...
		float grassViewDistanceSetting = gRenderer().GetRenderingSettings().grassViewDistance;
