...
namespace Utopian
{
   ...
   // The implementation of this function is from https://github.com/TheCherno/Hazel
   void ImGuiRenderer::DrawVec3Control(const std::string& label, glm::vec3& values, float resetValue, float columnWidth)
   {
      ImGuiIO& io = ImGui::GetIO();
   ...
   void ImGuiRenderer::SetDarkTheme()
   {
      ...
      colors[ImGuiCol_Header] = ImVec4(0.10f, 0.26f, 0.38f, 0.55f);
